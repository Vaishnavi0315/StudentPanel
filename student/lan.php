    ...
    <div class="content">
        ...
        <div class="language-selection">
            ...
            <select id="language" name="language">
                <option value="" selected disabled hidden> Select Preference: </option>
        ...
        <div class="imp">  <h1 class="rem">Remember </h1>
            <h4> You can select only one language, and you'll receive the report in the chosen language.
        </h4>
                    </div>
                    </div>
    </div>
